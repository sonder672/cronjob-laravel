                                    ...
                                    <form class="mx-1 mx-md-4" action="{{ route('register') }}" method="post">
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            ...
                                            <div class="form-outline flex-fill mb-0">
                                                <input type="text" id="form3Example1c"
                                                    ...
                                                    placeholder="Santiago Largo Díaz" class="form-control" />
                                                <label class="form-label" for="form3Example1c">Nombre y
                                                    apellido</label>
                                            </div>
                                            @error('name')
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            ...
                                            <div class="form-outline flex-fill mb-0">
                                                ...
                                                <label class="form-label" for="form3Example4c">Confirmar Contraseña</label>
                                            </div>
                                        </div>
